...
{
    /// <summary>
    /// Draws a string field as a dropdown of the audio ids that exist in the project.
    /// </summary>
    /// <remarks>
    ...
    ///
    /// <para>Put this on fields that <i>refer to</i> a sound. It does not belong on
    /// <see cref="AudioEntry"/>'s own id field, which is the field that <i>defines</i> one.</para>
    /// </remarks>
    [AttributeUsage(AttributeTargets.Field, AllowMultiple = false, Inherited = true)]
    public sealed class AudioIdAttribute : PropertyAttribute
    {
        public AudioIdAttribute(bool allowEmpty = false) => this.AllowEmpty = allowEmpty;

        /// <summary>Whether "no sound" is a legitimate value for this field.</summary>
