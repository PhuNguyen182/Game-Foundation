...
### VContainerAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [VContainerAnalyzer.Sample.csproj](../VContainerAnalyzer.Sample/VContainerAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### VContainerAnalyzer.Tests
