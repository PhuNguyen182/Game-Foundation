...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<VContainerAnalyzer.SampleSyntaxAnalyzer,
        VContainerAnalyzer.SampleCodeFixProvider>;

namespace VContainerAnalyzer.Tests;
