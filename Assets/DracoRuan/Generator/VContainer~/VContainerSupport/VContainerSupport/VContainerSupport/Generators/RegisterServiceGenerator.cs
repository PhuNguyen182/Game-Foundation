    ...
    private static void Execute(SourceProductionContext context, ImmutableArray<ServiceRegistrationModel> models)
    {
                     ...
                     registrationModel.LifetimeScopeName))
        {
            ...
            foreach (ServiceRegistrationModel item in serviceRegistrationModels)
            {
                ...
                stringBuilder.AppendLine($"namespace DracoRuan.VContainer{grouping.Key}{item.MinimalServiceName}Support.Generated");
                stringBuilder.AppendLine("{");
                
                string serviceType = item.IsEntryPoint ? "EntryPoint" : "Service";
                stringBuilder.AppendLine($"    public static class VContainer{grouping.Key}{item.MinimalServiceName}{serviceType}RegisterExtensions");
                stringBuilder.AppendLine("    {");
                ...
                context.AddSource($"VContainer{grouping.Key}{item.MinimalServiceName}{serviceType}Register.g.cs",
