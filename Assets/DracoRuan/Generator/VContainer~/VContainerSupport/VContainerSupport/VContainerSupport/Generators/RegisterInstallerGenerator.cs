...
public class RegisterInstallerGenerator : IIncrementalGenerator
{
    ...
    private static void Execute(SourceProductionContext context, ImmutableArray<InstallerRegistrationModel> models)
    {
        ...
        InstallerManagerStringBuilder.AppendLine($"     public static class RegisterInstallerManagerExtension");
        InstallerManagerStringBuilder.AppendLine("     {");
        InstallerManagerStringBuilder.AppendLine($"          public static async UniTask RegisterInstallerManager(this IContainerBuilder builder)");
        InstallerManagerStringBuilder.AppendLine("          {");
        ...
        InstallerManagerStringBuilder.AppendLine("}");
        var code = SourceText.From(InstallerManagerStringBuilder.ToString(), Encoding.UTF8);
        context.AddSource($"VContainerInstallerRegisterManager.g.cs", code);
    }
